...
-- Χρόνος δημιουργίας: 15 Ιουλ 2022 στις 20:54:03
...
--
-- Βάση δεδομένων: `populate_aggr_generation_per_type`
--
...
ALTER TABLE `generation`
  ...
  ADD KEY `ProductionType` (`ProductionType`);
...
--
ALTER TABLE `generation`
  MODIFY `table_index` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `generation`
  ...
  ADD CONSTRAINT `generation_ibfk_1` FOREIGN KEY (`ProductionType`) REFERENCES `productionkinds` (`ProductionType`) ON DELETE CASCADE ON UPDATE CASCADE,
