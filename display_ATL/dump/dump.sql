...
--
-- Βάση δεδομένων: `display_atl`
--

-- --------------------------------------------------------

--
-- Δομή πίνακα για τον πίνακα `actual_total_load`
--

CREATE TABLE `actual_total_load` (
...
--
-- Ευρετήρια για πίνακα `actual_total_load`
--
ALTER TABLE `actual_total_load`
...
--
-- AUTO_INCREMENT για πίνακα `actual_total_load`
--
ALTER TABLE `actual_total_load`
  MODIFY `table_index` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=249;
...
--
-- Περιορισμοί για πίνακα `actual_total_load`
--
ALTER TABLE `actual_total_load`
