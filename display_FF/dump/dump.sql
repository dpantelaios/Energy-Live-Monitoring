...
-- Χρόνος δημιουργίας: 15 Ιουλ 2022 στις 15:25:33
...
--
-- Δομή πίνακα για τον πίνακα `flowvalue`
--
...
--
-- Ευρετήρια για πίνακα `flowvalue`
--
...
--
-- AUTO_INCREMENT για πίνακα `flowvalue`
--
ALTER TABLE `flowvalue`
