...
-- Χρόνος δημιουργίας: 13 Ιουλ 2022 στις 19:10:39
...
--
-- Βάση δεδομένων: `populate_actual_total_load`
--

-- --------------------------------------------------------

--
-- Δομή πίνακα για τον πίνακα `actualtotalload`
--
...
--
-- Ευρετήρια για πίνακα `actualtotalload`
--
...
--
-- AUTO_INCREMENT για πίνακα `actualtotalload`
--
ALTER TABLE `actualtotalload`
  MODIFY `table_index` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
-- Περιορισμοί για πίνακα `actualtotalload`
--
ALTER TABLE `actualtotalload`
  ADD CONSTRAINT `map_code_foreign` FOREIGN KEY (`MapCode`) REFERENCES `country` (`MapCode`) ON DELETE CASCADE ON UPDATE CASCADE,
